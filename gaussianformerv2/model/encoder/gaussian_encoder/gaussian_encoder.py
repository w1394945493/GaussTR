...
class GaussianOccEncoder(BaseEncoder):
    ...
    def forward(
        ...
        **kwargs
        ...
        anchor_embed = self.anchor_encoder(anchor) # todo 锚框编码, 锚框内容包括 高斯属性(3+3+4+1)+语义属性(OCC中是17类)
