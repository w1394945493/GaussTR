...
class S3DCNN_challenge(nn.Module):
    def __init__(self,  input_planes = 64, out_planes = 1, planes = 16,  conv_3d_types1 = "3D", activate_fun = nn.ReLU(inplace=True), upsample = True):
...
class S3DCNN(nn.Module):
    ...
    def __init__(self,
                 input_planes = 64, out_planes = 1, planes = 16,
                 conv_3d_types1 = "3D", activate_fun = nn.ReLU(inplace=True),
                 is_upsample = False,
                 use_semantic = True,
                 semantic_classes = 18,
                 flow = 'no',
        ...
        if self.use_semantic:
            ...
            self.classif_semantic = nn.Sequential(convbn_3d(planes * 2, planes * 2, 3, 1, 1, conv_3d_types=conv_3d_types1),
                                      ...
                                      convbn_3d(planes * 2, self.semantic_classes, 3, 1, 1, conv_3d_types=conv_3d_types1),)
    ...
    def forward(self, cost): # todo cost: (b,)
